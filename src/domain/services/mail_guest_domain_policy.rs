//! Domain policy for MailGuest aggregate
//!
...
/// Domain policy for MailGuest — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<MailGuest>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type MailGuestDomainPolicy = PermitAllPolicy<MailGuest>;
