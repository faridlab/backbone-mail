//! Domain policy for FetchmailServer aggregate
//!
...
/// Domain policy for FetchmailServer — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<FetchmailServer>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type FetchmailServerDomainPolicy = PermitAllPolicy<FetchmailServer>;
