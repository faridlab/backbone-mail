//! Domain policy for PhoneBlacklist aggregate
//!
...
/// Domain policy for PhoneBlacklist — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<PhoneBlacklist>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type PhoneBlacklistDomainPolicy = PermitAllPolicy<PhoneBlacklist>;
