//! Domain policy for MailActivityPlan aggregate
//!
...
/// Domain policy for MailActivityPlan — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<MailActivityPlan>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type MailActivityPlanDomainPolicy = PermitAllPolicy<MailActivityPlan>;
