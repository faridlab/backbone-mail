//! Domain policy for MailMessageReaction aggregate
//!
...
/// Domain policy for MailMessageReaction — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<MailMessageReaction>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type MailMessageReactionDomainPolicy = PermitAllPolicy<MailMessageReaction>;
