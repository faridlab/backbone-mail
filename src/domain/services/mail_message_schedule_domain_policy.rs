//! Domain policy for MailMessageSchedule aggregate
//!
...
/// Domain policy for MailMessageSchedule — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<MailMessageSchedule>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type MailMessageScheduleDomainPolicy = PermitAllPolicy<MailMessageSchedule>;
