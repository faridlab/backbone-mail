//! Domain policy for MailScheduledMessage aggregate
//!
...
/// Domain policy for MailScheduledMessage — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<MailScheduledMessage>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type MailScheduledMessageDomainPolicy = PermitAllPolicy<MailScheduledMessage>;
