//! Domain policy for MailAttachment aggregate
//!
...
/// Domain policy for MailAttachment — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<MailAttachment>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type MailAttachmentDomainPolicy = PermitAllPolicy<MailAttachment>;
