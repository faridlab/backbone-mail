//! Domain policy for MailAlias aggregate
//!
...
/// Domain policy for MailAlias — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<MailAlias>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type MailAliasDomainPolicy = PermitAllPolicy<MailAlias>;
