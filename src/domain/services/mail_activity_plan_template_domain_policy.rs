//! Domain policy for MailActivityPlanTemplate aggregate
//!
...
/// Domain policy for MailActivityPlanTemplate — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<MailActivityPlanTemplate>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type MailActivityPlanTemplateDomainPolicy = PermitAllPolicy<MailActivityPlanTemplate>;
