//! Domain policy for MailMessageAttachment aggregate
//!
...
/// Domain policy for MailMessageAttachment — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<MailMessageAttachment>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type MailMessageAttachmentDomainPolicy = PermitAllPolicy<MailMessageAttachment>;
