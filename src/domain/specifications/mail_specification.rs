//! Specifications for Mail aggregate
//!
...
// Each predicate implements `Specification<Mail>` and can be combined
...
//
// pub struct ActiveMailSpec;
// impl Specification<Mail> for ActiveMailSpec {
//     fn is_satisfied_by(&self, e: &Mail) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
