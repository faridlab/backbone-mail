//! Specifications for MailServer aggregate
//!
...
// Each predicate implements `Specification<MailServer>` and can be combined
...
//
// pub struct ActiveMailServerSpec;
// impl Specification<MailServer> for ActiveMailServerSpec {
//     fn is_satisfied_by(&self, e: &MailServer) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
