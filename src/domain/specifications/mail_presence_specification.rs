//! Specifications for MailPresence aggregate
//!
...
// Each predicate implements `Specification<MailPresence>` and can be combined
...
//
// pub struct ActiveMailPresenceSpec;
// impl Specification<MailPresence> for ActiveMailPresenceSpec {
//     fn is_satisfied_by(&self, e: &MailPresence) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
