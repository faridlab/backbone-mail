//! Specifications for SmsTracker aggregate
//!
...
// Each predicate implements `Specification<SmsTracker>` and can be combined
...
//
// pub struct ActiveSmsTrackerSpec;
// impl Specification<SmsTracker> for ActiveSmsTrackerSpec {
//     fn is_satisfied_by(&self, e: &SmsTracker) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
