//! Specifications for MailAlias aggregate
//!
...
// Each predicate implements `Specification<MailAlias>` and can be combined
...
//
// pub struct ActiveMailAliasSpec;
// impl Specification<MailAlias> for ActiveMailAliasSpec {
//     fn is_satisfied_by(&self, e: &MailAlias) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
