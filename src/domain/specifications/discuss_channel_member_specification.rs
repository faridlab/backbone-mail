//! Specifications for DiscussChannelMember aggregate
//!
...
// Each predicate implements `Specification<DiscussChannelMember>` and can be combined
...
//
// pub struct ActiveDiscussChannelMemberSpec;
// impl Specification<DiscussChannelMember> for ActiveDiscussChannelMemberSpec {
//     fn is_satisfied_by(&self, e: &DiscussChannelMember) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
