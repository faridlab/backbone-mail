//! Specifications for Example aggregate
//!
...
// Each predicate implements `Specification<Example>` and can be combined
...
//
// pub struct ActiveExampleSpec;
// impl Specification<Example> for ActiveExampleSpec {
//     fn is_satisfied_by(&self, e: &Example) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
