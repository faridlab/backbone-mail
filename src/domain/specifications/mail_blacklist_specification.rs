//! Specifications for MailBlacklist aggregate
//!
...
// Each predicate implements `Specification<MailBlacklist>` and can be combined
...
//
// pub struct ActiveMailBlacklistSpec;
// impl Specification<MailBlacklist> for ActiveMailBlacklistSpec {
//     fn is_satisfied_by(&self, e: &MailBlacklist) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
