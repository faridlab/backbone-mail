//! Specifications for DiscussChannel aggregate
//!
...
// Each predicate implements `Specification<DiscussChannel>` and can be combined
...
//
// pub struct ActiveDiscussChannelSpec;
// impl Specification<DiscussChannel> for ActiveDiscussChannelSpec {
//     fn is_satisfied_by(&self, e: &DiscussChannel) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
