//! Specifications for PhoneBlacklist aggregate
//!
...
// Each predicate implements `Specification<PhoneBlacklist>` and can be combined
...
//
// pub struct ActivePhoneBlacklistSpec;
// impl Specification<PhoneBlacklist> for ActivePhoneBlacklistSpec {
//     fn is_satisfied_by(&self, e: &PhoneBlacklist) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
