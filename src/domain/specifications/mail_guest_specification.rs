//! Specifications for MailGuest aggregate
//!
...
// Each predicate implements `Specification<MailGuest>` and can be combined
...
//
// pub struct ActiveMailGuestSpec;
// impl Specification<MailGuest> for ActiveMailGuestSpec {
//     fn is_satisfied_by(&self, e: &MailGuest) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
