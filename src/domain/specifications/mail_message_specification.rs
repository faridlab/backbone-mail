//! Specifications for MailMessage aggregate
//!
...
// Each predicate implements `Specification<MailMessage>` and can be combined
...
//
// pub struct ActiveMailMessageSpec;
// impl Specification<MailMessage> for ActiveMailMessageSpec {
//     fn is_satisfied_by(&self, e: &MailMessage) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
