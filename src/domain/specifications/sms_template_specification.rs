//! Specifications for SmsTemplate aggregate
//!
...
// Each predicate implements `Specification<SmsTemplate>` and can be combined
...
//
// pub struct ActiveSmsTemplateSpec;
// impl Specification<SmsTemplate> for ActiveSmsTemplateSpec {
//     fn is_satisfied_by(&self, e: &SmsTemplate) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
