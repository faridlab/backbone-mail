...
--
-- This file contains initial seed data for the messaging.mail_guests table.
-- Customize this file to add your initial data.

-- INSERT INTO messaging.mail_guests (
--     id,
--     name,
--     country_id,
--     last_connection_dt,
...
-- INSERT INTO messaging.mail_guests (id, code, name, is_active, created_at, updated_at) VALUES
