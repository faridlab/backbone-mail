...
//!
//! Tests the Example CRUD API endpoints.
...
/// Test data generator for Example
pub struct ExampleTestData;

impl TestDataGenerator for ExampleTestData {
...
pub struct ExampleApiTest {
    inner: GenericCrudTest<ExampleTestData>,
}

impl ExampleApiTest {
    pub fn new() -> Self {
        let mut config = CrudTestConfig::new("/api/v1/examples", "Example");
        config.supports_soft_delete = true;
        Self {
            inner: GenericCrudTest::new(config, ExampleTestData),
        }
    }
...
impl Default for ExampleApiTest {
    fn default() -> Self {
        Self::new()
    }
}
...
mod tests {
    ...
    #[tokio::test]
    async fn test_example_crud() {
        let mut test = ExampleApiTest::new();
...
// <<< CUSTOM TESTS START >>>
// Add Example specific tests here
// <<< CUSTOM TESTS END >>>
