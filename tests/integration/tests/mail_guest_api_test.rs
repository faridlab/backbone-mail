//! MailGuest API Integration Tests
//!
//! Generated by metaphor-schema. Do not edit manually.
//!
//! Tests the MailGuest CRUD API endpoints.
...
// ============================================================================
// MAILGUEST TEST DATA GENERATOR
// ============================================================================

/// Test data generator for MailGuest
pub struct MailGuestTestData;

impl TestDataGenerator for MailGuestTestData {
...
/// MailGuest API test suite
pub struct MailGuestApiTest {
    inner: GenericCrudTest<MailGuestTestData>,
}

impl MailGuestApiTest {
    pub fn new() -> Self {
        let mut config = CrudTestConfig::new("/api/v1/mail_guests", "MailGuest");
        config.supports_soft_delete = true;
        Self {
            inner: GenericCrudTest::new(config, MailGuestTestData),
        }
    }
...
impl Default for MailGuestApiTest {
    fn default() -> Self {
        Self::new()
    }
}
...
// <<< CUSTOM TESTS START >>>
// Add MailGuest specific tests here
// <<< CUSTOM TESTS END >>>
